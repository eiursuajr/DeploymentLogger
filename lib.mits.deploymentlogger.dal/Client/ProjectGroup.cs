...
{
	public abstract class _ProjectGroup : SqlClientEntity
	{
		public _ProjectGroup()
		{
			this.QuerySource = "ProjectGroup";
			this.MappingName = "ProjectGroup";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadAllProjectGroup]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int ProjectGroupID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.ProjectGroupID, ProjectGroupID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadProjectGroupByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ProjectGroupID] = _ProjectGroup.PropertyNames.ProjectGroupID;
					ht[Name] = _ProjectGroup.PropertyNames.Name;
					ht[Description] = _ProjectGroup.PropertyNames.Description;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ProjectGroupID] = _ProjectGroup.ColumnNames.ProjectGroupID;
					ht[Name] = _ProjectGroup.ColumnNames.Name;
					ht[Description] = _ProjectGroup.ColumnNames.Description;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "InsertProjectGroup]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.ProjectGroupID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "UpdateProjectGroup]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "DeleteProjectGroup]";
