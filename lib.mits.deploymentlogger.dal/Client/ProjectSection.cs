...
{
	public abstract class _ProjectSection : SqlClientEntity
	{
		public _ProjectSection()
		{
			this.QuerySource = "ProjectSection";
			this.MappingName = "ProjectSection";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadAllProjectSection]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int ProjectSectionID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.ProjectSectionID, ProjectSectionID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadProjectSectionByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ProjectSectionID] = _ProjectSection.PropertyNames.ProjectSectionID;
					ht[ProjectID] = _ProjectSection.PropertyNames.ProjectID;
					ht[Name] = _ProjectSection.PropertyNames.Name;
					ht[Description] = _ProjectSection.PropertyNames.Description;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ProjectSectionID] = _ProjectSection.ColumnNames.ProjectSectionID;
					ht[ProjectID] = _ProjectSection.ColumnNames.ProjectID;
					ht[Name] = _ProjectSection.ColumnNames.Name;
					ht[Description] = _ProjectSection.ColumnNames.Description;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "InsertProjectSection]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.ProjectSectionID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "UpdateProjectSection]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "DeleteProjectSection]";
