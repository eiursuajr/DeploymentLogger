...
{
	public abstract class _LogEntryStatusNotificationType : SqlClientEntity
	{
		public _LogEntryStatusNotificationType()
		{
			this.QuerySource = "LogEntryStatusNotificationType";
			this.MappingName = "LogEntryStatusNotificationType";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadAllLogEntryStatusNotificationType]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int LogEntryStatusID, int NotificationTypeID)
		{
...
parameters.Add(Parameters.NotificationTypeID, NotificationTypeID);
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadLogEntryStatusNotificationTypeByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[LogEntryStatusID] = _LogEntryStatusNotificationType.PropertyNames.LogEntryStatusID;
					ht[NotificationTypeID] = _LogEntryStatusNotificationType.PropertyNames.NotificationTypeID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[LogEntryStatusID] = _LogEntryStatusNotificationType.ColumnNames.LogEntryStatusID;
					ht[NotificationTypeID] = _LogEntryStatusNotificationType.ColumnNames.NotificationTypeID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "InsertLogEntryStatusNotificationType]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "UpdateLogEntryStatusNotificationType]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "DeleteLogEntryStatusNotificationType]";
