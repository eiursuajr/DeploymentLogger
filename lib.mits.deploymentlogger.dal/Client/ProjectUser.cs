...
{
	public abstract class _ProjectUser : SqlClientEntity
	{
		public _ProjectUser()
		{
			this.QuerySource = "ProjectUser";
			this.MappingName = "ProjectUser";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadAllProjectUser]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int ProjectID, int UserID)
		{
...
parameters.Add(Parameters.UserID, UserID);
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "LoadProjectUserByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[ProjectID] = _ProjectUser.PropertyNames.ProjectID;
					ht[UserID] = _ProjectUser.PropertyNames.UserID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[ProjectID] = _ProjectUser.ColumnNames.ProjectID;
					ht[UserID] = _ProjectUser.ColumnNames.UserID;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "InsertProjectUser]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "UpdateProjectUser]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "DeleteProjectUser]";
